...
df= pd.read_excel("pybo\static\others\단기예보_위경도.xlsx")
df1=df.copy()
...
def get_weather_item(date,address):
    ...
    api="9mjKP5z2Q7D8AUC7p%2BQGHXKGAYVume2u6E6SLKF4deV6pXX9Ve7EnZ64LeGms0VH4Zu12h7R8t673SqcZO9%2BIA%3D%3D"
...
def get_xy(address):
    ...
    if size == 1:
        ...
        cond2=df3["2단계"].str.contains(arr[1])
        cond3=df2["3단계"].str.contains(arr[2])
